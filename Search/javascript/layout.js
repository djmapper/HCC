    ...
    if(configOptions.displaysplashscreen === 'true' || configOptions.displaysplashscreen === true) {
      if(getCookie('ArcGIS Online JavaScript Map Viewer') == null){
          ...
          else
          {
            ...
            $.blockUI({ message: $('#splashscreen'), css: { 'width': '250px','height': '200px','margin-top':'-100px'}});
...
/* ================ custom code by Rhys Donoghue at Eagle Technology Group Ltd ======================================= */
 ...
 function initSearch() {
        ...
        findTask = new esri.tasks.FindTask("http://s1-hcc.cloud.eaglegis.co.nz/arcgis/rest/services/AGOL_Property/PropertyInformation/MapServer");
        findTaskCemetery = new esri.tasks.FindTask("http://s1-hcc.cloud.eaglegis.co.nz/arcgis/rest/services/AGOL_Cemetery/Cemetery/MapServer");
...
function updateTypeAhead() {
 ...
 $("#searchField").autocomplete({
	            source: function (request, response) {
	                $.ajax({
	                    url: "http://s1-hcc.cloud.eaglegis.co.nz/WebServices/TypeAhead/searchJSON.ashx",
	                    dataType: "jsonp",
	                    data: {
